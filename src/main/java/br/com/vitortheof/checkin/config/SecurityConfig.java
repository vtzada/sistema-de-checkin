        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize ->
                        authorize.requestMatchers(HttpMethod.POST, "/auth/**").permitAll()
                                ...
                                .requestMatchers(HttpMethod.GET, "/evento/*/tipos-ingressos").permitAll()
                                .requestMatchers(HttpMethod.GET, "/evento/*/lotes-disponiveis").permitAll()
                                .requestMatchers(HttpMethod.GET, "/tipo-ingresso/*/lotes").permitAll()
